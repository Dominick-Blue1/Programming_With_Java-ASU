...
// FILENAME: Lab5.java
// SPECIFICATION: Producing different patterns based on the users input.
// FOR: CSE 110 - Lab #5
// TIME SPENT: 2 hours
//-----------------------------------------------------------*/
...
public class Lab5 {
    ...
    //     for (String numSpaces = 1; numSpaces <= numSymbols; numSpaces += 2) {
    //         int numDashed = (totalSymbOneRow - numSpaces) / 2;
    //         String row = buildRow(sideSymb, numDashed, midSymb, numSpaces);
    //         result += row + "\n";
    //     }
